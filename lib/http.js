...
function _sanitizeProfileAgentRecord(record) {
  ...
  const sanitizedRecord = {
    ...
    profileAgent: {
      id: profileAgent.id,
      sequence: profileAgent.sequence,
      account: profileAgent.account,
      profile: profileAgent.profile,
      controller: {
        id: profileAgent.controller.id,
        keystore: profileAgent.controller.keystore,
      },
      keystore: profileAgent.keystore,
      capabilityInvocationKey: profileAgent.capabilityInvocationKey,
    }
  };
