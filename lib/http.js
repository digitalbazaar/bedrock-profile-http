...
import {profiles, profileAgents, profileMeters} from '@bedrock/profile';
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      const edvOptions = {
        ...
        // FIXME: allow additional EDVs to be passed for creation either
        // through configuration or request (security model is different with
        // each of these options)
        //additionalEdvs: [{referenceId: 'credentials'}, {referenceId: 'inbox'}]
      };
