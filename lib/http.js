...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      // FIXME: in current usage, the only capability being dealt with is
      // the profileCapabilityInvocationKey, should this also deal other
      // capabilities in the `zcap` map if they are present?

      // FIXME: if zcaps.capabilitySetKak and zcaps.capabilitySetDocument
      // are set, those should be delegated as well.
      const capabilities = [
