...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      const {id: edvMeterId} = await _createMeter({
      ...
      const {id: kmsMeterId} = await _createMeter({
        // controller of meter is the app that runs bedrock-profile-http
        controller: client.id,
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      res.json({..._sanitizeProfileAgentRecord(profileAgentRecord), meters});
    }));
  ...
  app.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      // account there will be <= 10 profiles
  ...
  app.get(
    ...
    asyncHandler(async (req, res) => {
      ...
      res.json({...profileAgentRecord, meters});
    }));
