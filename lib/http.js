...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.post(
    ...
    asyncHandler(async (req, res) => {
      ...
      // FIXME: `keystoreOptions` must be passed; add default behavior that
      // uses configured meter zcap (that can auto-generate in dev mode) and
      // enable override to get some other meter zcap
